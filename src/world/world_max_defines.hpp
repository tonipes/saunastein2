...
#define MAX_WORLD_DRAW_CALLS		 1024
#define MAX_WORLD_RENDERABLE_OBJECTS 1024
#define MAX_GPU_BONES				 1024
#define MAX_GPU_ENTITIES			 1024

#define LIGHT_CULLING_ENERGY_THRESHOLD 0.01f

#define SHADOWS_MAX_CMD_BUFFERS			4
#define SHADOWS_CASCADES				4
#define MAX_SHADOW_CASTING_DIR_LIGHTS	1
#define MAX_SHADOW_CASTING_POINT_LIGHTS 6
#define MAX_SHADOW_CASTING_SPOT_LIGHTS	6
