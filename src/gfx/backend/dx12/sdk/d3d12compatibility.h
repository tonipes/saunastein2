...
#define __VulkanOn12CreatorID_INTERFACE_DEFINED__
	...
	VulkanOn12CreatorID : public IUnknown{public : };
	...
	typedef struct VulkanOn12CreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(VulkanOn12CreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(VulkanOn12CreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(VulkanOn12CreatorID* This);
...
#define VulkanOn12CreatorID_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define VulkanOn12CreatorID_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define VulkanOn12CreatorID_Release(This) ((This)->lpVtbl->Release(This))
...
#define __DirectMLWebNNCreatorID_INTERFACE_DEFINED__
	...
	DirectMLWebNNCreatorID : public IUnknown{public : };
	...
	typedef struct DirectMLWebNNCreatorIDVtbl
	{
		...
		DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(DirectMLWebNNCreatorID* This, REFIID riid, _COM_Outptr_ void** ppvObject);

		DECLSPEC_XFGVIRT(IUnknown, AddRef)
		ULONG(STDMETHODCALLTYPE* AddRef)(DirectMLWebNNCreatorID* This);

		DECLSPEC_XFGVIRT(IUnknown, Release)
		ULONG(STDMETHODCALLTYPE* Release)(DirectMLWebNNCreatorID* This);
...
#define DirectMLWebNNCreatorID_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define DirectMLWebNNCreatorID_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define DirectMLWebNNCreatorID_Release(This) ((This)->lpVtbl->Release(This))
